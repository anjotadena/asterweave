...
1. Re-read the approved scope, repository instructions, relevant implementation, analogous patterns, and detected stack rule pack.
...
8. Return changed files, behavior, decisions, tests added, commands run, remaining risks, and a `change` evidence summary.
